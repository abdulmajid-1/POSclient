                        ...
                        <div className="pt-14 p-6 space-y-6">
                            ...
                            <div className="pt-6 border-t border-slate-50 grid grid-cols-2 gap-4">
                                ...
                                <div className="bg-emerald-50 p-3 rounded-2xl">
                                    ...
                                    <p className="text-lg font-black text-emerald-700">{formatSAR(customer.totalSpent)}</p>
                                </div>
                                <div className="bg-red-50 p-3 rounded-2xl">
                                    <p className="text-[10px] uppercase font-bold text-red-600/60">Total Returns</p>
                                    <p className="text-lg font-black text-red-700">{customer.totalReturns || 0}</p>
                                </div>
                                <div className="bg-red-50 p-3 rounded-2xl">
                                    <p className="text-[10px] uppercase font-bold text-red-600/60">Total Refunded</p>
                                    <p className="text-lg font-black text-red-700">{formatSAR(customer.totalRefunded)}</p>
                                </div>
                            </div>
                        </div>
                    </div>
